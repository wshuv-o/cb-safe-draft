...
\midrule
\textbf{CB-SAFE+ (ours)} & \textbf{76.1} & \textbf{75.2} & \textbf{73.4} & \textbf{74.9$\pm$1.4} & \textbf{67.8} & \textbf{66.9} & \textbf{64.5} & \textbf{66.4$\pm$1.7} & \textbf{98/100} & \textbf{5} & \textbf{0.013} & \textbf{0.020} & \checkmark \\
