...
\caption{Ablation of CB-SAFE+ components under sign-flip (same protocol as Table~\ref{tab:signflip}). The trust-free variant uses no root dataset. Best per column in bold.}
