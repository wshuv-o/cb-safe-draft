...
\caption{Test accuracy (\%) under label-flip across four datasets and malicious fractions $f$; mean\,$\pm$\,std over 3 seeds where shown (CIFAR-10/FashionMNIST baselines single seed). FedGT is its real BCJR decoder~\cite{fedgt}, not evaluated on Edge-IIoTset (dash). Best per column in bold.}
\label{tab:labelflip}
